      ...
      createClass(_class, [{
        ...
        value: function renderedCallback() {
          ...
          if (this.sweep > Math.PI) {
            ...
            height = outerRadius - Math.sqrt(Math.pow(outerRadius, 2) - Math.pow(chordLength / 2, 2)) + this.thickness * Math.cos(this.sweep / 2);
          }
        ...
        get: function get() {
          return {
            ...
            thickness: number({ attribute: true, default: 100 }),
